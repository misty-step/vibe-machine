...
*   **Canvas Performance:** The visualizer uses a dedicated `requestAnimationFrame` loop outside of the standard React render cycle to ensure 60fps performance. React state updates triggers re-renders of the *container*, but the canvas contents are drawn imperatively.
