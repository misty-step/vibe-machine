          ...
          <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-6">
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                      <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Source_Video</h3>
                  ...
                  <div className="relative group">
                    ...
                    />
                    <div className={`h-32 border border-dashed border-white/10 rounded-sm flex flex-col items-center justify-center transition-all duration-300 group-hover:border-plasma/50 group-hover:bg-white/5 ${backgroundImage ? 'bg-zinc-900/50' : 'bg-black/20'}`}>
                      {backgroundImage ? (
                        <div className="relative w-full h-full overflow-hidden">
                            <img src={backgroundImage} className="object-cover w-full h-full opacity-60 group-hover:opacity-100 transition-opacity" alt="Background" />
                            <div className="absolute bottom-2 right-2 bg-black/80 text-plasma text-[9px] px-2 py-0.5 font-mono uppercase">IMG Loaded</div>
                        </div>
                      ) : (
                        <div className="flex flex-col items-center gap-2">
                            <Icons.Image className="w-5 h-5 text-zinc-700 group-hover:text-plasma transition-colors" />
                            <span className="text-[9px] text-zinc-600 font-mono uppercase">Drop Image</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                     <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Source_Audio</h3>
                     <span className="text-[9px] text-zinc-600 font-mono">{playlist.length.toString().padStart(2, '0')} FILES</span>
                  </div>
            ...
            {activeTab === 'style' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
                ...
                {/* Grid: Format */}
                <div className="space-y-2">
                    <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Output_Format</h3>
                ...
                {/* Grid: Mode */}
                <div className="space-y-2">
                    <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Viz_Engine</h3>
                    <div className="grid grid-cols-3 gap-1">
                        {[
                ...
                <div className="space-y-2">
                    <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Plasma_Frequency</h3>
                ...
                <div className="space-y-2">
                    <div className="flex justify-between">
                        <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Gain</h3>
                        <span className="text-[10px] font-mono text-plasma">{(settings.visualizerIntensity * 100).toFixed(0)}%</span>
                    </div>
                    <input 
                        type="range" 
                        min="0.1" 
